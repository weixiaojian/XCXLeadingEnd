<template>
    <view class="vue-cropper" ref="cropper" :style="{ top : `${containerTop}px` }" >
        ...
        <view class="uni-info__ft">
            <view class="ocr_cansel cropper_btn" style="color: rgb(0, 0, 0);" @tap="cancel">取消</view>
            <view class="ocr_suer cropper_btn"  @tap="confirm">确定</view>
        </view>
    </view>
</template>
...
<style scoped lang="css">
    ...
    .cropper-view-box {
        ...
        width: 100%;
        height: 100%;
        outline: 2rpx solid #FDD605;
        outline-color: #FDD605;
        user-select: none;
    }
